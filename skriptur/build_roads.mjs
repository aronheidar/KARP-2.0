...
const links = [
  ...
  { id: 'fr_house', from: 'frambod', to: 'husnaedi', coef: -0.30, lag: 3, unit: '%/%', ci_lo: -0.50, ci_hi: -0.12, source: 'Framboðs-teygni húsnæðis (OECD/HMS)' },
  ...
  { id: 'fr_rent', from: 'frambod', to: 'leiga', coef: -0.15, lag: 3, unit: '%/%', ci_lo: -0.30, ci_hi: -0.03, source: 'Framboð → lægri leiga' },
