...
export const EMAIL_TYPES = [
  ...
  // ── Vaktir & yfirlit (kvikt meginmál) ───────────────────────────────────────
  {
    ...
    // Efnislínur bera ekkert tákn (13.9.2026): viðtakendur eru regluverðir á Outlook þar sem emojí
    // birtist ósamræmt og spam-lega. Fast forskeyti „Karp · " gefur sömu skönnun og síun í pósthólfi.
    subject: 'Karp · Vikuyfirlitið þitt',
    intro: '', footer: '',
  ...
  },
  {
    ...
    subject: 'Karp · Fréttavakt: {{lysing}}',
    intro: '', footer: '',
  ...
  },
  {
    ...
    breytur: ['kt'], krafist: [],
    subject: 'Karp · Áreiðanleikavaktin: kritísk breyting ({{kt}})',
    intro: 'Kritísk vöktunar-breyting á vöktuðu félagi {{kt}}:',
    footer: 'Skoðaðu möppuna: https://karp.is/areidanleikavaktin/?kt={{kt}}',
  },
  {
    id: 'kyc_digest', label: 'Compliance-morgunfundurinn (viku-forgangsröðun)', flokkur: 'kvikur', hopur: 'Vaktir & yfirlit',
    ritanlegt: ['subject', 'intro', 'footer'],
    ...
    subject: 'Karp · Morgunfundurinn: {{fjoldi}} félög þurfa athygli · {{obreytt}} án breytinga',
  ...
  },
  {
    ...
    breytur: ['fjoldi', 'lysing'], krafist: [],
    subject: 'Karp · Orðsporsvakt: {{lysing}}',
  ...
  },
  {
    ...
    subject: 'Karp · Lögbirting: {{lysing}}',
