...
import { EVENT_MYNDIR, PM_MYNDIR, ALTHINGI_MYND, myndFyrirAtvik } from './myndir.mjs';
...
const allar = [...Object.entries(EVENT_MYNDIR), ...Object.entries(PM_MYNDIR).map(([k, v]) => ['pm:' + k, v]), ['althingi', ALTHINGI_MYND]];
